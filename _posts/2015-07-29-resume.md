...
- Working on very high throughput back-end services in Java. Other tech used: Docker, Kafka, Zookeeper, Cassandra...
...
- <strong>Other</strong>: Linux, Docker, Kafka, Apache libraries, Gradle, Maven, Jenkins, Atlassian tools
